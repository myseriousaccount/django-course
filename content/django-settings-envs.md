...
> <i class="bi bi-book"></i> Офіційний орієнтир — «Deployment checklist» у документації Django: там перелічено все, що треба змінити перед продом (DEBUG, SECRET_KEY, ALLOWED_HOSTS, HTTPS-налаштування).
