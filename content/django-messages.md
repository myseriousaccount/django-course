...
> <i class="bi bi-book"></i> Першоджерело — розділ «The messages framework» у документації Django (docs.djangoproject.com), де описано рівні, теги, зберігання та тонкощі виводу.
