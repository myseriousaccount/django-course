...
- **Ручні перевірки там, де їх багато.** Для двох-трьох полів `if` у view нормальні, але коли правил десяток і треба показувати помилки біля кожного поля, форма коротша й надійніша за власний код.
