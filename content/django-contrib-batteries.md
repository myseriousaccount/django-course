...
> <i class="bi bi-pin-angle"></i> `django.contrib` — лише одна з частин фреймворку. Повна карта модулів (`db`, `urls`, `http`, `forms`, `core`, `utils`) і таблиця «задача → що імпортувати» — в уроці «Карта модулів Django».
