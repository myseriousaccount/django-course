...
## Дві команди: makemigrations і migrate
...
## Коли міграція не проходить

Два випадки, у яких `migrate` зупиняється або ставить запитання в терміналі: таблиця вже містить рядки, а нове правило їх не влаштовує.
